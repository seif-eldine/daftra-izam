...
app.get("/jobs", (req, res) => {
    if(fs.existsSync("jobs.json")) return res.json(JSON.parse(fs.readFileSync("jobs.json", "utf8")));
    else return res.json([
        {id: '1', title: "Gaming UI Designer", company: "Rockstar Games", tags: ["Creative / Design", "IT / Software Development"], location: "New York", postedAt: "10 Days ago", criterias: ["UI/UX", "Adobe XD", "Photoshop"], logoPath: "logoo.png"},
        {id: '2', title: "Senior Designer", company: "Egabi Games", tags: ["Creative / Design", "IT / Software Development"], location: "New York", postedAt: "10 Days ago", criterias: ["UI/UX", "Adobe XD", "Illustrator"], logoPath: "logo.png"},
        {id: '3', title: "React Dev", company: "Rockstar Games", tags: ["Creative / Design", "IT / Software Development"], location: "New York", postedAt: "10 Days ago", criterias: ["UI/UX", "Adobe XD", "Photoshop"], logoPath: "logooo.png"},
        {id: '4', title: "Java Dev", company: "Egabi Games", tags: ["Creative / Design", "IT / Software Development"], location: "New York", postedAt: "10 Days ago", criterias: ["UI/UX", "Adobe XD", "Photoshop"], logoPath: "logoo.png"},
